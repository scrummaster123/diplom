...
namespace Afisha.Infrastructure.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Locations",
                columns: new[] { "Id", "IsWarmPlace", "Name", "OwnerId", "Pricing" },
                values: new object[,]
                {
                    { 1L, false, "ДК Колхозник", 1L, 100m },
                    { 2L, false, "Supr puper mega place", 1L, 1000m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateOnly(2025, 2, 4), 1L, 1L },
                    { 2L, new DateOnly(2025, 2, 4), 1L, 1L }
                });
